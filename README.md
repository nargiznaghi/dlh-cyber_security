...
A comprehensive cybersecurity study repository structured around foundational coursework, applied blue team operations, and an interactive Study Hub. Content aligns with the CompTIA Security+ (SY0-701) certification exam domains and NIST/CIS security frameworks.

---

## 🔗 Interactive Study Hub

All learning objectives, cheat sheets, frameworks, and reference materials are systematically maintained in our dedicated platform:


* 🛡️ **[Defensive Security Section](https://nishtman-k.github.io/cyber-study-hub/?tab=defensive)** *(Managed and regularly updated by [@nargiznaghi](https://github.com/nargiznaghi))*
...
|-----------|-------------|
| [`blue_team/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/blue_team) | Cybersecurity defensive operations through a scenario-driven case study (MedDefense) |
| [`common_core/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core) | Foundational coursework covering key Security+ domains |
...
This directory contains the foundational modules and core topics forming the fundamental baseline knowledge for this repository.

> **Maintained by:** Nargiz Naghiyeva ([@nargiznaghi](https://github.com/nargiznaghi))

### Core Modules

| Module / Directory | Description | Security+ Domains Covered |
|--------------------|-------------|--------------------------|
| [`cybersecurity_basics/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core/cybersecurity_basics) | Fundamental security concepts, terminology, and principles | Domain 1.0: Attacks, Threats, and Vulnerabilities |
| [`linux_security/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core/linux_security) | Linux system fundamentals, command line, permissions, and security | Domain 3.0: Architecture, Domain 4.0: Operations |
| [`network_security/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core/network_security) | Network protocols, architecture, and network security fundamentals | Domain 1.0, Domain 2.0: Technologies and Tools |
| [`scripting_cyber/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core/scripting_cyber) | Scripting and automation basics (Bash/Python) for security workflows | Domain 4.0: Operations and Incident Response |
| [`web_application_security/`](https://github.com/nargiznaghi/dlh-cyber_security/tree/main/common_core/web_application_security) | Web applications, common vulnerabilities, and security standards | Domain 1.0: Application Security |
...
Practical platforms to supplement theoretical knowledge and scenario modules:
