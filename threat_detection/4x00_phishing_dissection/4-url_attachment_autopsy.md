...
- Evidence from email: Embedded login re-verification link in Email 2 targeting user Diane Marsh.
- Safe investigation method: whois meddefense-portal.com, dig meddefense-portal.com, urlscan.io lookup.
- Finding: Typosquatted/lookalike domain impersonating official MedDefense portal; sending IP failed SPF/DMARC.
- Risk rating: HIGH
...
- Safe investigation method: whois outlook-protection.com, VirusTotal lookup, Passive DNS lookup.
...
- Safe investigation method: curl -I hxxp://203[.]0[.]113[.]228, threat intelligence lookups on IP 203.0.113.228.
...
- Evidence from email: Sender domain claiming to be billing infrastructure for MedEquip Supplies.
- Safe investigation method: whois medequip-supplies.net, dig TXT medequip-supplies.net (SPF verification).
...
- Indicator type: Domain / URL
- Evidence from email: Embedded link in open-enrollment notification urging immediate login.
- Safe investigation method: whois meddefense-benefits.org, urlscan.io scan history lookup.
- Finding: Spoofed HR benefits domain registered externally; fails all authentication checks (SPF/DKIM/DMARC).
- Risk rating: HIGH
